...
import (
	...
	apisinstasliceoperatorv1 "github.com/openshift/instaslice-operator/pkg/apis/instasliceoperator/v1"
	...
	instasliceoperatorv1 "github.com/openshift/instaslice-operator/pkg/generated/listers/instasliceoperator/v1"
...
type InstasliceOperatorInformer interface {
	...
	Lister() instasliceoperatorv1.InstasliceOperatorLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.OpenShiftOperatorV1().InstasliceOperators(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OpenShiftOperatorV1().InstasliceOperators(namespace).Watch(context.TODO(), options)
			},
		},
		&apisinstasliceoperatorv1.InstasliceOperator{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *instasliceOperatorInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisinstasliceoperatorv1.InstasliceOperator{}, f.defaultInformer)
}

func (f *instasliceOperatorInformer) Lister() instasliceoperatorv1.InstasliceOperatorLister {
	return instasliceoperatorv1.NewInstasliceOperatorLister(f.Informer().GetIndexer())
}
