...
func InstasliceOperator(name, namespace string) *InstasliceOperatorApplyConfiguration {
	...
	b.WithAPIVersion("inference.redhat.com/v1")
	return b
}
...
// Experimental!
func ExtractInstasliceOperator(instasliceOperator *instasliceoperatorv1.InstasliceOperator, fieldManager string) (*InstasliceOperatorApplyConfiguration, error) {
...
// Experimental!
func ExtractInstasliceOperatorStatus(instasliceOperator *instasliceoperatorv1.InstasliceOperator, fieldManager string) (*InstasliceOperatorApplyConfiguration, error) {
	return extractInstasliceOperator(instasliceOperator, fieldManager, "status")
}

func extractInstasliceOperator(instasliceOperator *instasliceoperatorv1.InstasliceOperator, fieldManager string, subresource string) (*InstasliceOperatorApplyConfiguration, error) {
	b := &InstasliceOperatorApplyConfiguration{}
	err := managedfields.ExtractInto(instasliceOperator, internal.Parser().Type("com.github.openshift.instaslice-operator.pkg.apis.instasliceoperator.v1.InstasliceOperator"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
...
func (b *InstasliceOperatorApplyConfiguration) WithCreationTimestamp(value apismetav1.Time) *InstasliceOperatorApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *InstasliceOperatorApplyConfiguration) WithDeletionTimestamp(value apismetav1.Time) *InstasliceOperatorApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *InstasliceOperatorApplyConfiguration) WithOwnerReferences(values ...*metav1.OwnerReferenceApplyConfiguration) *InstasliceOperatorApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {
