...
func (b *InstasliceOperatorStatusApplyConfiguration) WithConditions(values ...*operatorv1.OperatorConditionApplyConfiguration) *InstasliceOperatorStatusApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *InstasliceOperatorStatusApplyConfiguration) WithGenerations(values ...*operatorv1.GenerationStatusApplyConfiguration) *InstasliceOperatorStatusApplyConfiguration {
	for i := range values {
		if values[i] == nil {
